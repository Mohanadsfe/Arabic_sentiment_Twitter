...
def do_sa(n, my_classifier):
    ...
    print(metrics.classification_report(y_test, y_predicted, target_names=['pos', 'neg'], zero_division='warn'))
    ...
    print('sample of features:', random.sample(sorted(feature_names), 200))
    

##SVC()
if __name__ == '__main__':
    ngrams = (1, 2, 3)
    classifiers = [LinearSVC(), MultinomialNB(), SVC()
