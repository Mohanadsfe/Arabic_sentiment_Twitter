...
def split_count(text):
    ...
    for word in data:
        if any(char in emoji.EMOJI_DATA.keys() for char in word):
            emoji_list.append(word)

    return emoji_list


pos_training = 'arabic_tweets_tsv/20190413/train_Arabic_tweets_positive_20190413.tsv'
neg_training = 'arabic_tweets_tsv/20190413/train_Arabic_tweets_negative_20190413.tsv'

pos_testing = 'arabic_tweets_tsv/20190413/test_Arabic_tweets_positive_20190413.tsv'
neg_testing = 'arabic_tweets_tsv/20190413/test_Arabic_tweets_negative_20190413.tsv'
